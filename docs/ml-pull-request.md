...
Opening a pull request will trigger a[workflow](../.github/workflows/titanic_oct_2024-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-984752964297111.11.azuredatabricks.net/explore/data/models/staging/titanic_oct_2024/titanic_oct_2024-model)
* [Prod model in UC](https://adb-984752964297111.11.azuredatabricks.net/explore/data/models/prod/titanic_oct_2024/titanic_oct_2024-model)
. 
