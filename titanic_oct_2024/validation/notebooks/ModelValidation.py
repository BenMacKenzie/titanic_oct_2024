...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``titanic_oct_2024/resources/model-workflow-resource.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in titanic_oct_2024/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in titanic_oct_2024/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-titanic_oct_2024-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev.titanic_oct_2024.titanic_oct_2024-model", "Full (Three-Level) Model Name")
